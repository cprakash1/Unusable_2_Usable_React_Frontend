...
// const { campgrounds } = useContext(GlobalContext);
// let campgroundsMap = { features: campgrounds };
...
//   let content = campgroundsMap.map((c) => {
//     if (
...
//                     ${
//                       c.image.length !== 0
//                         ? `<img class="img-fluid img-thumbnail" src="${c.image[0].HomePage}" alt="">`
//                         : `<img class="img-fluid img-thumbnail" src="https://res.cloudinary.com/dhtxywza0/image/upload/w_400,h_300/v1684793983/YelpCamp/bqlyxwcqzivezngcbwic.jpg" alt="">`
//                     }
//                     </div>
//                     <div class="col-md-8">
//                     <div class="card-body">
...
//     }
//   });
//   let result = campgroundsMap.map((c) => {
//     if (
//       c.title.toLowerCase().includes(text.toLowerCase()) ||
//       c.location.toLowerCase().includes(text.toLowerCase()) ||
//       c.description.toLowerCase().includes(text.toLowerCase())
...
export function searchInputChange(map, text, campgrounds) {
  console.log(map);
  let campgroundsMap = { features: campgrounds };
  const cpu = document.querySelector("#cp");
  let content = campgrounds.map((c) => {
    if (
      c.title.toLowerCase().includes(text.toLowerCase()) ||
      c.location.toLowerCase().includes(text.toLowerCase()) ||
      c.description.toLowerCase().includes(text.toLowerCase())
